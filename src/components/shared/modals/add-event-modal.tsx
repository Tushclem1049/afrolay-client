        ...
        <div className="flex flex-col gap-y-4">
          <p className="flex-1 flex flex-col w-full gap-2 text-sm font-medium text-neutral-800 items-start">
            ...
            <input
              ...
              className={cn(
                "w-full p-2 outline-none border border-orange-200/80 appearance-none max-w-full bg-white text-black focus:ring-2 focus-visible:ring-2 focus:ring-orange-400/40 ",
          ...
          <p className="flex-1 flex flex-col w-full gap-2 text-sm font-medium text-neutral-800 items-start">
            ...
            <input
              ...
              onChange={(e) => props.handleShipmentEventChange(e)}
              className={cn(
                "w-full p-2 outline-none border border-orange-200/80 max-w-full bg-white text-black focus:ring-2 focus-visible:ring-2 focus:ring-orange-400/40 ",
                isEventErrors(eventErrors) &&
